  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(158 42% 10% / 0.95), hsl(0 0% 7% / 0.95))",
          backdropFilter: "blur(16px)",
          border: "1px solid hsl(46 65% 52% / 0.2)",
          boxShadow: "0 4px 20px hsl(0 0% 0% / 0.5)",
        }}
      >
        Chat with us on WhatsApp / Discutez avec nous
      </div>

      <a
        href="https://wa.me/27740444913?text=Hello%20Safariluxe!%20I%20am%20interested%20in%20booking%20a%20premium%20tour."
        target="_blank"
        ...
        style={{
          background:
            "linear-gradient(135deg, #2de26f 0%, #25D366 50%, #1da851 100%)",
          boxShadow:
            "0 4px 20px hsl(142 60% 45% / 0.45), 0 2px 8px hsl(0 0% 0% / 0.4)",
        }}
