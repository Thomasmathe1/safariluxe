...
export function Statistics() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, hsl(158 42% 10%) 0%, hsl(158 32% 8%) 100%)",
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse 70% 100% at 50% 50%, hsl(46 65% 52% / 0.07) 0%, transparent 70%)",
        }}
      />
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div
                ...
                style={{
                  textShadow: "0 0 40px hsl(46 65% 52% / 0.3)",
                }}
              >
                {stat.value}
              </div>
